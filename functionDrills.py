...
name = ""
#8) Define a function that takes in a string that is the name of a color. If that string is0 equal to your favorite color, it prints "That's my favorite color!" If it is not, it prints "That is not my favorite color. Try again."
favoriteColor = "red"
...
def checkColor(newColor):
    if newColor == favoriteColor:
        ...
        answer = "Thats not my favorite color.Try Again"
    return answer
